import { Collection, Feature, FeatureCollection, FunctionMetadata, QueryParams, UpdateFeatureParams } from "@/types";
import BaseProvider from "./base-provider";
import { OGCAPIConformanceItem } from "@/types/ogc-confirmance";


// Example implementation with extended features
export class InMemoryBackend extends BaseProvider {
    ...
    async getSchema(collectionId: string): Promise<Promise<Record<string, unknown>> | Record<string, unknown>> {
